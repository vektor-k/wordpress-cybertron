...
WIN_FUNC_DECL(IoRegisterPlugPlayNotification, 7)
...
WIN_FUNC_DECL(IoUnregisterPlugPlayNotification, 1)
WIN_FUNC_DECL(IoWMIOpenBlock, 3)
WIN_FUNC_DECL(IoWMIQueryAllData, 3)
...
struct wrap_export ntoskernel_io_exports[] = {
	...
	WIN_SYMBOL(IoRegisterPlugPlayNotification, 7),
	...
	WIN_SYMBOL(IoUnregisterPlugPlayNotification, 1),
	WIN_SYMBOL(IoWMIOpenBlock, 3),
	WIN_SYMBOL(IoWMIQueryAllData, 3),
